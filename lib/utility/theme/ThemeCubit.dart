...
class ThemeCubit extends Cubit<ThemeData> {
  ...
  void toggleTheme(){
    if(state==ThemeData.light().copyWith(primaryColorLight: Colors.white,appBarTheme:  AppBarTheme(
        titleTextStyle:GoogleFonts.inter(fontWeight: FontWeight.w600,fontSize: 20,color:
        Colors.black),
